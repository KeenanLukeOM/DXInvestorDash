<template>
  <div class="the-site-footer container p-4 text-center">
    ...
    <p class="text-gray-700 text-sm py-8 dark:text-gray-400">
      🍻 <strong class="ml-1">Tip Jar:</strong> dxinvestordash.eth<br>
    ...
    <p class="text-gray-600 text-sm dark:text-gray-500">
      This project is open-source. Source code available on <a href="https://github.com/InsideTheSim/DXInvestorDash.com" target="_blank" ref="nofollow, noopener" style="text-decoration: underline;">Github</a>.
    </p>
  </div>
</template>
